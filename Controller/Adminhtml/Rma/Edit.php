...
class Edit extends \Magemonkey\RMA\Controller\Adminhtml\Rma
{
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('magemonkey_rma_rma', $model);
        ...
        $resultPage->getConfig()->getTitle()->prepend(__('Rmas'));
        $resultPage->getConfig()->getTitle()->prepend($model->getId() ? __('# %1', $model->getId()) : __('New Rma'));
        return $resultPage;
    }
}
